# Generated by Django 2.2.24 on 2023-01-10 19:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observacao_comparsas', models.TextField(blank=True, null=True, verbose_name='Observação Comparsas')),
                ('observacao_bairro', models.TextField(blank=True, null=True, verbose_name='Observação Bairro')),
                ('status_atual', models.CharField(choices=[('foragido', 'Foragido'), ('morto', 'Morto'), ('preso', 'Preso'), ('solto', 'Livre'), ('torno', 'Tornozelado')], default='foragido', max_length=8)),

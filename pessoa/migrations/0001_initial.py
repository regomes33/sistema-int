    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='criado em')),
                ('modified', models.DateTimeField(auto_now=True, verbose_name='modificado em')),
                ('tipo_telefone', models.CharField(choices=[('cel', 'Celular'), ('tel', 'Telefone')], default='cel', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rg', models.CharField(blank=True, max_length=11, null=True, verbose_name='RG')),
                ('cnh', models.CharField(blank=True, max_length=20, null=True, verbose_name='CNH')),
                ('nome_comparsa', models.CharField(blank=True, max_length=100, null=True, verbose_name='nome')),
                ('pessoa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pessoa.Pessoa')),
            ],
            options={

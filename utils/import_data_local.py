...
path = '/home/regis/Dropbox/projetos/1finalizados/regomes/backup/200924'

filename_auth_user = f'{path}/auth_user_200924.csv'
filename_ocorrencia_areaupm = f'{path}/ocorrencia_areaupm_200924.csv'
filename_ocorrencia_arma = f'{path}/ocorrencia_arma_200924.csv'
filename_ocorrencia_autoria = f'{path}/ocorrencia_autoria_200924.csv'
filename_ocorrencia_genero = f'{path}/ocorrencia_genero_200924.csv'
filename_ocorrencia_homicidio = f'{path}/ocorrencia_homicidio_200924.csv'
filename_ocorrencia_infracao = f'{path}/ocorrencia_infracao_200924.csv'
filename_ocorrencia_motivacao = f'{path}/ocorrencia_motivacao_200924.csv'
filename_ocorrencia_natureza = f'{path}/ocorrencia_natureza_200924.csv'
filename_ocorrencia_ocorrencia = f'{path}/ocorrencia_ocorrencia_200924.csv'
filename_ocorrencia_ocorrenciaveiculo = f'{path}/ocorrencia_ocorrenciaveiculo_200924.csv'
filename_ocorrencia_pessoaocorrencia = f'{path}/ocorrencia_pessoaocorrencia_200924.csv'
filename_pessoa_comparsa = f'{path}/pessoa_comparsa_200924.csv'
filename_pessoa_faccao = f'{path}/pessoa_faccao_200924.csv'
filename_pessoa_foto = f'{path}/pessoa_foto_200924.csv'
filename_pessoa_pessoa = f'{path}/pessoa_pessoa_200924.csv'
filename_pessoa_pessoacontato = f'{path}/pessoa_pessoacontato_200924.csv'
filename_pessoa_pessoaveiculo = f'{path}/pessoa_pessoaveiculo_200924.csv'
filename_pessoa_tatuagem = f'{path}/pessoa_tatuagem_200924.csv'
filename_veiculo_cor = f'{path}/veiculo_cor_200924.csv'
filename_veiculo_modelo = f'{path}/veiculo_modelo_200924.csv'
filename_veiculo_veiculo = f'{path}/veiculo_veiculo_200924.csv'
...
def get_data(filename):
    ...
    '''
    # if LOCAL:
    return read_data(csv_to_list(filename))
...
def import_pessoa_comparsa(filename):
    ...
    for item in items, 'Pessoa Comparsas: ':
